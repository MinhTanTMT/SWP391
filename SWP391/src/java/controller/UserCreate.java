...
public class UserCreate extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (account != null) {
            ...
            if (obj.checkInputInfo(full_name) && obj.checkInputInfo(address) && obj.checkInputInfo(dob)) {
                if (obj.checkTimeTrue(dob)) {
                    if (obj.checkPhone(phone)) {

                        Inforuser b = new Inforuser(account.getId(), account.getId(), full_name, dob, address, phone, gender, null);
                        obj.insertInfo(b);
