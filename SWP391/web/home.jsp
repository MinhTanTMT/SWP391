            ...
            <div id="header">
                <div id="header-left">
                    ...
                    <div id="menu">
                        ...
                        <div class="item">
                            <a class="item-menu-content" href="cart">Giỏ Hàng</a>
                        </div>
                        <div class="item">
                            <a class="item-menu-content" href="login">Login</a>
                        </div>
                        <div class="item">
                            <a class="item-menu-content" href=""><h2>${requestScope.account.username}</h2></a>
                        </div>
                    </div>
                </div>
